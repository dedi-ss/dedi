...
* Company     : dss link center
* Release     : September 2024
* Update      : -
* Website     : https://dsslink.vercel.app/
* E-mail      : dsslinkcenter@gmail.com
* WhatsApp    : +62-812-9804-0103
-->
...
<head>
    ...
    <!-- Title -->
    <title>Aplikasi CRUD PHP 8, MySQL 8, Bootstrap 5 dan jQuery</title>
    ...
    <footer class="footer mt-auto bg-white shadow py-4">
        <div class="container-fluid px-lg-5">
            ...
            <div class="copyright text-center mb-2 mb-md-0">
                &copy; 2023 - <a href="https://dsslink.vercel.app/" target="_blank" class="text-brand text-decoration-none">dsslinkcenter</a>. All rights reserved.
            </div>
        </div>
    </footer>
